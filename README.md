...
- 웹소켓을 이용한 통신을 통해 실시간 채팅 기능을 개발하였고 이 과정에서 백엔드와 긴밀하게 협업을 하여 커뮤니케이션
능력을 길렀습니다.
- 회원, 비회원, 관리자 등급에 따른 기능 분기 처리를 하였습니다
- 다른 프론트엔드 팀원들과 지속적으로 커뮤니케이션을 하며 팀원들이 힘들어하는 부분을 지속적인 도움을 줬습니다.
결과적으로 팀원들이 NextJs에 적응하는데 기여를했습니다.
